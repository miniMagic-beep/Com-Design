...
class pkt_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_bladerf_source_0_0.set_sample_rate(0, 768e3)
        self.soapy_bladerf_source_0_0.set_bandwidth(0, 200)
        self.soapy_bladerf_source_0_0.set_frequency(0, 200e6)
        self.soapy_bladerf_source_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0_0.set_gain(0, min(max(20, -1.0), 60.0))
        self.soapy_bladerf_sink_0_0 = None
        dev = 'driver=bladerf'
        stream_args = ''
        tune_args = ['']
        settings = ['']

        self.soapy_bladerf_sink_0_0 = soapy.sink(dev, "fc32", 1, '',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0_0.set_sample_rate(0, 768e3)
        self.soapy_bladerf_sink_0_0.set_bandwidth(0, 200)
        self.soapy_bladerf_sink_0_0.set_frequency(0, 200e6)
        self.soapy_bladerf_sink_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_0_0.set_gain(0, min(max(20, 17.0), 73.0))
        self._rf_range = Range(0, 200, 1, 20, 200)
        self._rf_win = RangeWidget(self._rf_range, self.set_rf, "'rf'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._correction_range = Range(0, 100, 1, 0, 200)
        ...
        self.connect((self.zeromq_sub_source_0, 0), (self.soapy_bladerf_sink_0_0, 0))
